...
You understand that the Deployery project distributes Contributions under the Deployery Community License (as may be updated from time to time), and that Your Contributions may also be made available under other licenses at the discretion of the project.
...
2. Each Contribution is Your original creation (see Section 7 for submissions on behalf of others).
